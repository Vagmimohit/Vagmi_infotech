...
$themes = ["attorney", "church", "education", "fitness", "hosting", "medic", "real-estate", "restaurant", "spa", "travel"];
$themes_str = "";
for(var i=0; i<$themes.length; i++){
	$img = 	"images/style-picker/"+$themes[i]+".png";	
	$themes_str += '<li>';
	$themes_str += '<a id="'+$themes[i]+'" href="' + $themes[i] + '.html" title="">';
	$themes_str += '<img src="'+ $img +'" alt="theme-'+$themes[i]+'" title="theme-'+$themes[i]+'"/>'
	$themes_str += '</a>';
	$themes_str += '</li>'; 
}
...
$str += '			</ul>';
$str += '			<div class="hr"> </div>';
$str += '			<h3> Special Pages </h3>';
$str += '			<ul class="theme-picker">';
$str += 				$themes_str;
$str += '			</ul>';
$str += '		</div>';
$str += '		</div>';
